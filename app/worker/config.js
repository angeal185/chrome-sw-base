...
CSP = "default-src 'self';img-src *;object-src 'none';frame-src 'none';block-all-mixed-content;upgrade-insecure-requests;connect-src "+ ORIGIN +"/ ;report-to default;report-uri "+ RP +";",
...
BASE_HTML = '<!DOCTYPE html><script src="./app/main.mjs" type="module" name="main" defer></script></head><body></body></html>',
REPORT_TO = '{"group":"default","max_age":31536000,"endpoints":[{"url":'+ RT +'}],"include_subdomains":false}',
BASE_PAGE = new Blob([BASE_HTML], {type : 'text/html'}),
SEC_HEAD = {
